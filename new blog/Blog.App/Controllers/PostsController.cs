...
namespace Blog.App.Controllers
{
    ...
    public class PostsController : ControllerBase
    {
        ...
        public PostsController(BlogDbContext db, IMapper mapper)
        {
            this.db = db;
            this.mapper = mapper;
        }
        ...
        [AllowAnonymous]
        [HttpGet]
        public ActionResult Get(int pageIndex, int itemsPerPage)
        {
        ...
        public ActionResult<Post> GetById(int id)
        {
            ...
            return Ok(mapper.Map<Post, PostViewModel>(post));
        }
